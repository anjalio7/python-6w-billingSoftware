...
class DetailBill:
    ...
    def firstFrame(self, id):
                ...
                self.lab=Label(self.mainFrame,text=f"Bill given To :- {self.client}",fg="black",bg="#D4D4D4")
                self.lab.place(x=0,y=20,width="500",height="70")
                ...
                self.lab=Label(self.mainFrame,text="DATE :- " + str(self.dates),fg="black",bg="#D4D4D4")
                self.lab.place(x=20,y=160,width="500",height="70")
                self.lab.config(font=("Modern No. 20",20,"bold"))

                self.lab=Label(self.mainFrame,text=f"Product :- {self.product}",fg="black",bg="#D4D4D4")
                self.lab.place(x=20,y=240,width="500",height="70")
                self.lab.config(font=("Modern No. 20",20,"bold"))

                self.lab=Label(self.mainFrame,text=f"Quantity :- {self.quantity}",fg="black",bg="#D4D4D4")
                self.lab.place(x=20,y=320,width="500",height="70")
                self.lab.config(font=("Modern No. 20",20,"bold"))

                self.lab=Label(self.mainFrame,text=f"Cost :- {self.cost}",fg="black",bg="#D4D4D4")
                self.lab.place(x=20,y=400,width="500",height="70")
                self.lab.config(font=("Modern No. 20",20,"bold"))
                ...
                self.lab=Label(self.mainFrame,text=f"TOTAL :- {self.totalCost}",fg="black",bg="#D4D4D4")
