...
class AddCategory:
        ...
        def openHOME(self):
                self.root.destroy()
                addCategoryObj = HOME.AdminNav()
                addCategoryObj.navframe()
        ...
        def abc(self):
                ...
                if (self.ent.get() == ''):
                        messagebox.showinfo('Alert', 'Please enter Category name.')     
                elif(not(self.ent.get().isalpha())):
                        messagebox.showinfo('Alert', 'Please enter valid name.') 
                
                else:
                        res = database.addcategory(self.data)
                        print('res')
                        if res:
