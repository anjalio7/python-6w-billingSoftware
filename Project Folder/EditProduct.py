...
class editproduct:
        ...
        def firstFrame(self, data):
                ...
                print(data)
                res = database.selectProduct(data)
                if res:
                        self.ent.insert(0, (res[0], res[1]))
                        self.ent1.insert(0, res[2])
                        self.ent2.insert(0, res[3])
                        self.ent3.insert(0, res[4])
                        self.ent4.insert(0, res[5])
                self.root.mainloop()
        def openHOME(self):
                self.root.destroy()
                Obj = HOME.AdminNav()
