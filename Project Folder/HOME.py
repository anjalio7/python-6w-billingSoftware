...
import database
import todayBill
import manageCategory, manageSubCategory
...
class AdminNav:
        ...
        def __init__(self):
                ...
                self.Category = Menu(self.menu)
                self.menu.add_cascade(label= "Category" , menu=self.Category)
                self.Category.add_command(label="Add",command=self.openAddCategory)
                self.Category.add_command(label="Manage",command=self.openManageCategory)

                self.subCategory = Menu(self.menu)
                self.menu.add_cascade(label= "subCategory" , menu=self.subCategory)
                self.subCategory.add_command(label="Add",command=self.openAddSubCategory)
                self.subCategory.add_command(label="Manage",command=self.openManageSubCategory)
        ...
        def openAddCategory(self):
                self.root.destroy()
                addClientObj = addcategory.AddCategory()
                addClientObj.firstFrame()

        def openAddSubCategory(self):
                self.root.destroy()
                addClientObj = addSubCategory.AddsubCategory()
                addClientObj.firstFrame()
        ...
        def openManageCategory(self):
                self.root.destroy()
                obj = manageCategory.ManageCategory()
                obj.firstFrame()

        def openManageSubCategory(self):
                self.root.destroy()
                obj = manageSubCategory.ManageCategory()
                obj.firstFrame()
