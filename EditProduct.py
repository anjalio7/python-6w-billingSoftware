...
class editproduct:
        ...
        def firstFrame(self, data):
                ...
                self.lab1=Label(self.mainFrame,text="Stock :-",anchor=E,fg="black",bg="#e4e4e4")
                self.lab1.place(x=200,y=300,width="100",height="30")
                self.lab1.config(font=("Modern No. 20",20))

                self.name=StringVar()
                self.ent0=Entry(self.mainFrame,textvariable=self.name)
                self.ent0.place(x=400,y=200,width="150",height="30")
                ...
                for i in database.selectProduct(data):
        ...
        def abc(self):
                ...
                if (self.ent.get() == ''):
                        ...
                        res = database.updateProduct(self.data)
                        print(res)
                        if res:
